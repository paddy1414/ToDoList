...
public class DoneListView extends ListActivity {
    ...
    private void updateUI() {
        Cursor cursor = helper.fetchAllRemindersBydone();
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        Toast.makeText(DoneListView.this, getString(R.string.itemPicked) + position, Toast.LENGTH_SHORT).show();
